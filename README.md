...
- 🛡️ Extrae el **ratio de solvencia** (`R0620` — Ratio of Eligible own funds to SCR), por país y por ramo (Vida / No-Vida / Todas)
...
- ⚙️ Ejecución manual — los datos de EIOPA se publican trimestralmente, no tiene sentido automatizar una ejecución diaria
